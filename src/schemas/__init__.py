...
__all__ = ['CreateDraftRequest', 'CreateDraftResponse', 'AddVideosRequest', 'AddVideosResponse', 'GenVideoRequest', 'GenVideoResponse', 'SaveDraftRequest', 'SaveDraftResponse', 'GetDraftRequest', 'GetDraftResponse', 'GetAudioDurationRequest', 'GetAudioDurationResponse']