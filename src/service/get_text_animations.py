"""
Logic for retrieving text animation lists.
"""
from typing import List, Dict, Any
from src.utils.logger import logger
from exceptions import CustomException, CustomError
from src.pyJianYingDraft.metadata import TextAnimationType

def get_text_animations(mode: int = 0) -> List[Dict[str, Any]]:
    """
    Retrieve list of text animations.
