...
class WindowLayoutMixin:
    ...
    def _build_ui_compact(self) -> None:
        ...
        font_grid.addWidget(self.sticker_combo, 5, 1, 1, 4)
        font_grid.addWidget(self._field_label("Bắt đầu"), 6, 0)
        font_grid.addWidget(self.sticker_start_time, 6, 1, 1, 2)
        font_grid.addWidget(self._field_label("Kết thúc"), 6, 3)
        font_grid.addWidget(self.sticker_end_time, 6, 4)
        font_grid.addWidget(self._field_label("Tối đa từ/dòng"), 7, 0)
        font_grid.addWidget(self.max_words_spin, 7, 1)
        font_grid.addWidget(self.font_color_btn, 7, 2, 1, 3)
        font_grid.addWidget(self._field_label("Palette màu chữ"), 8, 0)
        font_grid.addLayout(self._build_palette_row("fontColor", FONT_COLOR_SWATCHES), 8, 1, 1, 4)
        font_grid.addWidget(self._field_label("Palette màu viền"), 9, 0)
        font_grid.addLayout(self._build_palette_row("strokeColor", STROKE_COLOR_SWATCHES), 9, 1, 1, 4)
        font_grid.addWidget(self.stroke_color_btn, 10, 0, 1, 2)
